...
export default function Header() {
  ...
  useEffect(() => {
    ...
    setSessionCount(stored ? parseInt(stored) : 0);
  }, []);
            ...
            <div className="flex items-center space-x-1 sm:space-x-3 flex-shrink-0">
              ...
              <div className="hidden xl:flex items-center space-x-2">
                <div className="flex items-center space-x-2 px-3 py-1.5 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200/50">
                  ...
                  <div className="text-xs">
                    <span className="text-green-700 font-semibold">{sessionCount}</span>
                    <span className="text-green-600 ml-1">créés</span>
                  </div>
                </div>
              ...
              <div className="flex xl:hidden items-center space-x-1 sm:space-x-2">
                <div className="flex items-center space-x-1 px-1.5 py-1 sm:px-2 sm:py-1 bg-green-50 rounded-md">
                  ...
                  <span className="text-xs text-green-700 font-semibold">{sessionCount}</span>
                </div>
              ...
              <div className="relative">
                ...
                >
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-br from-persona-violet to-purple-600 rounded-full flex items-center justify-center text-white text-xs font-bold shadow-md">
                    U
                  </div>
                  <div className="hidden lg:block text-left">
                    <p className="text-xs font-semibold text-neutral-900">Utilisateur</p>
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-neutral-200 py-2 z-50 animate-in slide-in-from-top-2 duration-200">
                    <div className="px-3 py-2 border-b border-neutral-100">
                      <div className="flex items-center space-x-2">
                        <div className="w-8 h-8 bg-gradient-to-br from-persona-violet to-purple-600 rounded-full flex items-center justify-center text-white text-xs font-bold">
                          U
                        </div>
                        <div>
                          <p className="text-xs font-semibold text-neutral-900">Utilisateur</p>
                          <p className="text-xs text-neutral-600">user@example.com</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="border-t border-neutral-100 pt-1">
                      <button className="w-full text-left px-3 py-2 text-xs text-red-600 hover:bg-red-50 flex items-center space-x-2 transition-colors">
